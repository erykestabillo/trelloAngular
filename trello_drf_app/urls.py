...
urlpatterns = [
    ...
    path('board/list/<int:list_id>/edit/', ListDetail.as_view({'get':'get','put':'put','delete':'delete'}),name="list-detail"),
    ...
    #path('board/<int:list_id>/<int:card_id>/drag/', CardDetail.as_view({'put':'cardDrag'}),name="card-drag"),
